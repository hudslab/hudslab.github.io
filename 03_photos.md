...
<div style="display: flex; flex-wrap: wrap; gap: 10px; width: 100%; margin-top: 20px;">
  ...
  <div style="flex: 1 1 calc(50% - 10px); min-width: 280px;">
    <img src="/assets/images/2026_conference/KST_spring/KST_spring_YCW_v2.jpg" alt="KST Spring YCW" style="width: 100%; height: 250px; object-fit: cover; border-radius: 5px;">
  </div>
</div>
